...
public interface IInquiryService<DATA, ID> {
	...
	Page<DATA> findByCodeOrderByIdAsc(String p_Code, Pageable p_Pageable) throws ServiceException;
	...
	Page<DATA> findByNameOrderByIdAsc(String p_Name, Pageable p_Pageable) throws ServiceException;
